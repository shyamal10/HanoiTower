...
def menu_screen():  # to be called before starting actual game loop
    ...
    while not menu_done:  # every screen/scene/level has its own loop
        ...
        blit_text(screen, 'Towers of Hanoi', (413, 122), font_name='sans serif', size=90, color=grey)
        blit_text(screen, 'Towers of Hanoi', (411, 120), font_name='sans serif', size=90, color=black)
        blit_text(screen, 'Use arrow keys to select difficulty:', (420, 220), font_name='sans serif', size=30,
                  color=black)
        blit_text(screen, str(n_disks), (420, 260), font_name='sans serif', size=40, color=white)
        blit_text(screen, 'Press ENTER to continue', (420, 320), font_name='sans_serif', size=30, color=black)
...
def game_over():  # game over screen
    ...
    if min_steps < steps:
        blit_text(screen, 'You Lost!', (320, 200), font_name='sans serif', size=72, color=gold)
        blit_text(screen, 'You Lost!', (322, 202), font_name='sans serif', size=72, color=gold)
    if min_steps == steps:
...
def draw_ptr():
    ...
    pygame.draw.polygon(screen, black, ptr_points)
    return
